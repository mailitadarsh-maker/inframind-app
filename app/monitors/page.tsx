...
export default function DashboardPage() {
  ...
  const NAV = [
    { href: '/monitors', label: 'Monitors', active: true,
    ...
    <>
      ...
      <div className="im" onClick={() => setOpenDropdown(null)}>
        ...
        <aside className="im-sb">
          ...
          <Link href="/dashboard" style={{ display: "flex", alignItems: "center", gap: 8, padding: "9px 10px", borderRadius: 8, fontSize: 12, fontWeight: 500, color: "#6b7280", textDecoration: "none", marginBottom: 16, transition: "color 0.12s", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }} onMouseEnter={e => (e.currentTarget.style.color="#6b7280")} onMouseLeave={e => (e.currentTarget.style.color="#3a3f52")}><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" width="13" height="13"><path d="M10 8H3M6 5l-3 3 3 3" /></svg>Dashboard</Link>
