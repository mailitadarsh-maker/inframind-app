...
function downEmailHtml(name: string, url: string, type: string, cause: string, action: string | null, severity: string | null): string {
  ...
  return '<!DOCTYPE html><html><head><meta charset="utf-8"></head>'
    ...
    + '<tr><td align="center" style="padding-top:4px"><a href="https://inframindhq.online/login?redirect=/dashboard" style="display:inline-block;background:#34d399;color:#0a0a0a;font-size:14px;font-weight:700;text-decoration:none;padding:12px 30px;border-radius:8px">View Dashboard</a></td></tr>'
